...
public class DeprecatedAvroSchemaUtil {
  ...
  public static Schema convert(
    ...
    return TypeUtil.visit(schema, new DeprecatedTypeToSchema(names));
  }
  ...
  public static Schema convert(Type type, Map<Types.StructType, String> names) {
    return TypeUtil.visit(type, new DeprecatedTypeToSchema(names));
  }
  ...
  public static Map<Type, Schema> convertTypes(Types.StructType type, String name) {
    DeprecatedTypeToSchema converter = new DeprecatedTypeToSchema(ImmutableMap.of(type, name));
