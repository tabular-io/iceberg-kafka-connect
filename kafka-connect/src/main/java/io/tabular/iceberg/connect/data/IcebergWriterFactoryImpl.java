...
public class IcebergWriterFactoryImpl implements IcebergWriterFactory {

  private static final Logger LOG = LoggerFactory.getLogger(IcebergWriterFactoryImpl.class);

  private final Catalog catalog;
  private final IcebergSinkConfig config;

  public IcebergWriterFactoryImpl(Catalog catalog, IcebergSinkConfig config) {
