...
/* Copied from  org.apache.iceberg.common.DynClasses.java
  Due to wanting to avoid packaging Hadoop/Hive libraries in
  versions of the connector that don't require it, we need
  to adjust the class loader to handle an additional error
*/
public class AlternateDynClasses {

  private AlternateDynClasses() {}
  ...
  public static class Builder {
    ...
    public Builder impl(String className) {
      ...
      try {
        ...
        // We strip hadoop/hive classes from one of the jars produced by the connector
        // which causes this error rather than a ClassNotFoundException when attempting to
        // detect Hive/Hadoop and it does not exist
      }
