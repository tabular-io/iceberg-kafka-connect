...
public class SchemaUtils {
  ...
  private static void commitSchemaUpdates(Table table, SchemaUpdate.Consumer updates) {
    ...
    List<SchemaUpdate.MakeOptional> makeOptionals =
  ...
  private static boolean columnExists(
      org.apache.iceberg.Schema schema, SchemaUpdate.AddColumn update) {
    StructType struct =
  ...
  private static boolean typeMatches(
      org.apache.iceberg.Schema schema, SchemaUpdate.UpdateType update) {
    return schema.findType(update.name()).typeId() == update.type().typeId();
  }

  private static boolean isOptional(
      org.apache.iceberg.Schema schema, SchemaUpdate.MakeOptional update) {
