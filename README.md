...
| iceberg.tables.default-partition-by        | Default comma-separated partition spec to use when creating tables                                            |
...
| iceberg.table.\<table name\>.partition-by  | Comma-separated partition spec to use when creating the table                                                 |
